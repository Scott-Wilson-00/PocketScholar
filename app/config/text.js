export default {
  aboutText: {
    ...
    whyDoesPsExist2:
      ...
      "The '<i><u>Student Debt Crisis</u></i>' is a familiar phrase for the majority of Canadians, but many don’t recognize the weight that it carries. Fewer still, are the students like you and I that understand how student debt could influence the way we live our lives in the future.\n\n" +
      "There is an alarming amount of students who graduate <b>tens of thousands of dollars</b> in student debt, which can take years to repay. Moreover, it is reported that in Canada during 2018, student debt contributed to about 18% of insolvencies (people not being able to pay their debts on time). The average student debtor was 35 years old and still had almost $15,000 in student debt, making up over 30% of their debt to repay!\n\n" +
      "By holding debt for an extended period of time as a young adult, you rob yourself of one of your greatest wealth-building tools: <i>compound interest.</i> To learn more about the powers of compound interest, visit the <b>Resources</b> page of PocketScholar.\n\n" +
    ...
    psInfoPages:
      ...
      "<b>1.</b> Do I understand what’s being said? If so, do I agree with it? Why or why not?\n\n" +
      "<b>2.</b> Am I practicing what I agree with? If not, what’s stopping me? (Answer: probably nothing!)\n\n" +
      "<b>3.</b> What can I do to better apply the principles that I’ve discovered?\n\n" +
    ...
    aboutPage:
      "The <b>About</b> page is your one-stop shop on learning how to use PocketScholar to its maximum potential. It contains the background information on why you should take control of your future now, and it also gives you the tools for learning how to do so!\n\n",
    getStartedPage:
      "It will take lots of time and energy, but the quest for improvement is definitely worth it. The <b>Get Started</b> page ensures that your time and energy is well spent and that you’re rewarded for your efforts.\n\n" +
      "However, your rewards will not only come in the form of scholarships. When you grow as a result of your work, you’ll find that you gain confidence, meaningful relationships, and useful skills. You will have likely helped others along the way, and demonstrated excellence or innovation in fields of your interest. You’ll know you have grown as a person, and you <b>won't <i>need</i></b> to win any scholarships to validate that fact!\n\n" +
      "The <b>Get Started</b> page will outline steps to take as you navigate your environment. There are no one-size-fits-all guidelines that can be provided to guarantee your progress, but with the help of versatile advice, learning from others’ experiences, and some active self-reflection, you are entirely capable of producing a personalized plan of action that will work for you.\n\n",
    challengesPage:
      "There are plenty of challenges that you may run into when you are striving to be your best, so contrary to how it may appear, the <b>Challenges</b> page isn’t there to give you more. In fact, it will highlight some of the toughest hurdles you might encounter and offer methods which you can take advantage of to overcome them!\n\n",
    psInteractable:
      ...
      "Take the time to <b>review</b> what you have accomplished and <b>plan</b> where to head next. Stepping back to take a look at the big picture is an indispensable habit that you should form as soon as possible, the more you do it, the more you notice how much doing so helps!\n\n" +
    ...
    activityList:
      ...
      "<b>Fields:</b>\n" +
      "<u>Name:</u> The name of the activity you participated in or the organization it belonged to (eg: Greenpeace Canada)\n\n" +
      "<u>Period of Involvement:</u> The date at which you began the activity and the date you ended *or whether the activity is ongoing* (eg: April 2019 - February 2021)\n\n" +
      "<u>Commitment:</u> The amount of time you commit to the activity, measured in either hours/week or hours/month (eg: 2h/week)\n\n" +
      "<u>Key Roles/Responsibilities:</u> What are you responsible for in the activity and how does that impact others? (eg: Event Coordinator: organized a food drive for homeless shelters in order to reduce the environmental impact of food waste)\n\n" +
      "<u>Awards / Achievements:</u> What have you accomplished in your role? Have you won any awards? Think of what that says about your character. (eg: Initiated over 400 contributions to food drives, eliminating over 60kg of food wastage)\n\n" +
    ...
    tracker:
      ...
      "<b>Fields:</b>\n" +
      "<u>Name:</u> The name of the scholarship / the organization that provides it (eg: TD Community Leadership)\n\n" +
      "<u>Deadline:</u> The date that submissions are due (eg: March 16th, 2023)\n\n" +
      "<u>Value:</u> The amount of money the scholarship is worth (eg: $10,000,000!)\n\n" +
      "<u>Criteria / Special Requirements:</u> Some scholarships have specific criteria to be eligible to win (eg: specific to engineering students) (eg: must be / be the child of someone employed at [company])\n\n" +
      "<u>Essay Topic:</u> Does this scholarship require an essay or written component? What is it about? (eg: How should countries approach the needs of public health vs. those of individual privacy?)\n\n",
    promptsPage:
    ...
    resourcesPage:
      ...
      "<u>Scholarship Search Engines</u> - you can take a look at scholarships which are up for grabs and learn more about post-secondary education.\n\n" +
      "<u>Book Recommendations</u> -  a collection of some of my favorite reads that have relevant connections to the goals of PocketScholar.\n\n" +
      "<u>Additional Resources</u> - to help you go above and beyond what PocketScholar has to offer and continue your self learning.\n\n" +
      "<u>Sources</u> - my english teacher would be mad at me otherwise.\n\n" +
    ...
    notes:
      ...
      "<b>6)</b> Thank you to Freepik, photo3idea_studio, Pixelmeetup, and Catalin Fertu for sourcing media used in PocketScholar.\n\n",
    copyright:
      "Copyright © 2021 Scott Wilson\n\n" +
      "All Rights Reserved.  No part of this application may be reproduced, stored in a retrieval system, or transmitted, in any form or in any means – by electronic, mechanical, photocopying, recording or otherwise – without prior written permission.",
  },
  getStartedText: {
    whatsAScholarship:
      "Scholarships are free money... <b>aren’t they?</b> While there is a sliver of truth in that common saying, depicting them as ‘free’ can be pretty misleading. Free money implies that there is little to no work to be done to earn it - and that couldn’t be further from the truth.\n\n" +
      ...
      "<b>Potential.</b> This is the reason that the vast majority of donors offer scholarships. They see you following a positive, upward trend, and they provide financial aid to accelerate your growth. A scholarship is an investment in its recipient - the student who demonstrates high potential and is likely to give back to the community in the future. By maintaining their momentum, the student is on course to convert their potential into even greater results than they have already realized.\n\n" +
      "<b>Self-Check:</b>\n" +
    ...
    investInYourself:
      ...
      "Before others will have the faith to make an investment in you, you need to be consistently <b>investing in yourself</b> first. To put it plainly, you should see each and every day as an opportunity to become better than - or accomplish more than - the person you were yesterday.\n\n" +
      ...
      "<b>Self-Check:</b>\n" +
      "- Which activities do I partake in, and what achievements have I currently made that forecast my future success?\n\n" +
    ...
    equation3:
      ...
      "In real life, analyzing your own activities of interest using this equation will help you get a better sense of what you gain from the activities, and whether they are worth your thought, effort, and time. The objective is to determine whether an activity is worthy of being used to invest in yourself.\n\n",
    breakdownIngredients:
      ...
      "<b>-></b> What need does this club fulfill / Who does it help?\n\n<b>-></b> How many others would be interested and willing to join?\n\n<b>-></b> What would club meetings and activities look like?\n\n<b>-></b> What resources do I need?\n\n<b>-></b> How should I promote the club?\n\n<b>-></b> And many more…\n\n" +
      ...
      "<b>-></b> Is my club promotional material attractive and informative?\n\n<b>-></b> Is the content of my meetings engaging and useful?\n\n<b>-></b> Am I leading the meetings with enthusiasm and energy?\n\n" +
      "<u><b>Time</b></u>\n" +
      ...
      "<b>-></b> Am I spending an adequate amount of time preparing for club meetings?\n\n<b>-></b> How frequent should meetings be to create a positive impact on myself and others?\n\n" +
      "Once you have invested the necessary thought, effort, and time into your endeavour, you’re going to start seeing the fruits of your labour. Progress will seem slow and steady at first, but as your list of self-investment activities lengthens, your new assets will compound and assist you in gaining even more!\n\n",
    ...
    breakdownResults:
      ...
      "<b>-></b> Leadership and group management\n\n<b>-></b> Public Speaking\n\n<b>-></b>Time Management\n\n<b>-></b>Creative Thinking\n\n" +
      "<u><b>Character</b></u>\n" +
      ...
      "<b>-></b> 'Since starting my club, I’ve felt more, <u>confident</u> to share my ideas with others'\n\n<b>-></b> 'After having a dispute about the topic of the next meeting, I realized that I should become more <u>open-minded</u> to the opinions of others.' \n\n<b>-></b>'After the last meeting’s flop, I did some <u>retrospective thinking</u> and made necessary changes. Everyone loved today’s meeting!'\n\n" +
      "<u><b>Wisdom</b></u>\n" +
      ...
      "<b>-></b> Taking feedback and criticism graciously is very important. You can use it as an opportunity to better yourself and your work.\n\n<b>-></b> You can’t please everyone, so just do the best you can. Understanding that not everyone will agree with you or support you is healthy and will eliminate unproductive stress.\n\n" +
    ...
    applyEquation3:
      "You can frequently and easily practice applying Equation #3 by referring back to PocketScholar. Take a look at your <b>Activity List</b> and work each activity into the equation.\n\n" +
      ...
      "<b>-></b> Does this activity provide me with skills, build my character, or increase my wisdom? (It could be all 3!) Are these skills/traits/lessons useful outside of this particular activity?\n\n" +
      "<b>-></b> Are these results worth my investment into the activity?\n\n" +
      "<b>-></b> This activity shows promise for personal growth. Am I willing to invest the necessary thought, effort, and time into it?\n\n" +
    ...
    fashionPassion:
      "Once again, to successfully invest in yourself, you need to ensure your energy is put to good use, and you need to <u>enjoy</u> the process of self-investment just as much as the outcome.\n\n" +
      ...
      "When I was younger, I always envisioned that discovering my passion would be some major tipping point in my life. I thought that one day, while doing something ordinary, I would have a moment of intense fulfillment and realize that what I was doing was my true passion. I would treasure my passion, strive for excellence, master it, and live happily ever after. <b>How naive.</b> That moment of realization hasn’t come and I doubt it ever will.\n\n" +
      "<i>It probably won’t ever come for you either.</i>\n\n" +
      "Fortunately for you and me both, I do have passions! Over time I have come to reevaluate what developing a passion means to the average person. <u>A passion is a developed interest that you foster over a long period of time.</u>\n\n" +
      "You start off with an inkling of interest in a subject, so you test the waters. As months... years pass, you gradually explore the depth of the subject, then before you know it you’ll have formed an intense fascination with what could now be considered your passion!\n\n" +
    ...
    hideAndSeek:
      "Assuming you haven’t already established a passion or two, you’re still in one of many exploratory phases you'll have in your life. You have a general idea of your interests, your likes and dislikes, but that’s probably the extent of it. You might be overwhelmed with all the possibilities that the world has to offer, or maybe you’re more like I was, that is, oblivious to them. Either way, <i>that has to change.</i>\n\n" +
      ...
      "Imagine yourself playing an exceptionally long game of <b>hide and seek;</b> you’re the hunter, and your passions are the hunted. You don’t know where they’ll turn up, so you are going to have to scout your entire landscape to determine where to look first. That is, do some research on a few general fields of your choosing. Then select a subfield that looks appealing to you. This might be a small interest that you’ve had for a while, or something completely new that catches your attention.\n\n" +
      "<u>Intrigued by art?</u> Try out drawing something that you think is cool, or watch some tutorials on 3D animation! <u>Fascinated by technology?</u> Read about the latest advances in artificial intelligence, or mess around with a DIY circuitry project!\n\n" +
      "Do a preliminary evaluation of the area for a short period of time, at least a couple of weeks. Test run it yourself by doing research, performing activities, or talking to people familiar with the field! Give yourself adequate time to develop some fundamental skills and knowledge, then ask the following: \n\n<b>-></b> Does anything grab my attention? What stands out to me?\n\n<b>-></b> How might this interest be simultaneously used to invest in myself?\n\n" +
      ...
      "<b>Self-Check:</b>\n" +
      "- When is the last time I have taken on a new activity or actively sought out a new interest?\n\n- Assess how deep-rooted your current routines and range of activities are. How often am I willing to engage with new things that I’m unfamiliar with?\n\n- Do I wait for new opportunities to come to me, or do I actively explore and hunt them down?\n\n",

    breakOut:
      "Take it easy! You’ve been working so hard, there’s no need to go out of your way and expand your comfort zone… <i>Right?</i>\n\n" +
      "It’s really easy to get comfortable with your present environment and confine yourself to familiar surroundings. It’s one thing to be happy with who you are and what you’re doing today, but a completely different story if you think you’ll be happy cruising in this current state for the rest of your life. That’s called <b>complacency.</b> If you feel it, be cautious, because disruption will arrive sooner than you think! Instead of <b>being forced</b> to change because of your situation, get in the driver's seat and <b>be the force</b> that makes your situation change!\n\n" +
      ...
      "I hesitated to put myself in uncomfortable situations that I might have not known how to handle, to talk to new people who seemed to share nothing in common, or to do complex things with no idea where to start. Because of this, I have undoubtedly <u>passed up</u> chances to meet amazing new people, to learn and grow, and to share novel experiences with others.\n\n" +
      "Reflect on how often you break the boundaries of your comfort. When was the last time you made yourself uncomfortable on purpose? Warm up with <b>daily</b> baby steps like striking up a short 1-2 minute conversation with a stranger at school, work or someone you otherwise rarely talk to. If you're impatient, you could <i>throw yourself into the flames instead.</i>\n\n" +
      "I was petrified the first time I spoke in front of <i>hundreds</i> of people. Quaking in my size 5 dress shoes, my stone cold figure took the stage. It was far from perfect, but the speech lifted a monstrous weight of anxiety off my shoulders and replaced it with a healthy amount of confidence that would stay with me to this day. Just like how after getting off the highway, normal roads seem to move at a snail's pace, no crowd felt too large after my younger self’s first feat of public speaking.\n\n" +
      "You should seek out challenges that scare you (a little or a lot), be it technical, social, intellectual or otherwise. <i>Bit by bit</i> you can begin to deconstruct your walls, or use a <i>wrecking-ball</i> to tear them to the ground. Either way, the ultimate goal is to build something superior in their place.\n\n" +
      "<b>It’s time to broaden your environment.</b> Now you're armed with the investment equations, the knowledge to identify your interests and maybe even some industrial machinery. Using those weapons you can fend off the enemy that is stagnation. With new environments come new people, experiences, knowledge, and challenges, all of which build your potential to fuel a brighter future.\n\n" +
      "<b>Self-Check:</b>\n" +
    ...
    youThePatient:
      "You can be diagnosed and even be prescribed remedies. Though however hard the doctor tries, they can never cure you themselves. The patient is the only one that can take the medication, the necessary action to make themselves better… <i>literally</i>!\n\n" +
      "Only <i>you</i> can better yourself through the thought, effort, and time you invest. Your potential, and therefore your achievements, are molded by your own actions, so what you accomplish is a direct output of who you are as a person, and <u>how hard you’re willing to compete with yesterday’s self.</u>\n\n" +
      ...
      "In the end, there is no reason to not want to improve yourself. Even if you don’t want to be more skilled, amicable, courageous, imaginative, or knowledgable, investing in yourself will <b>skyrocket</b> your scholarship opportunities! It will be hard work (not to mention fun work), but you will be kickstarting your financial future which will pay off for the rest of your life.\n\n" +
      "So, the blueprint has been handed to you, but when will you strike the first nail? I suggest tomorrow. For today, check out challenges you might encounter on the Challenges page, and explore the Resources page to dive deeper into what’s been introduced so far.\n\n" +
      "Best of all, get started by tracking your current activities in the Activity List and imagine what it will look like six months from now. <b>Then tomorrow, you start make it happen!</b>\n\n",
    ...
    recap:
      ...
      "Enjoy yourself <i>every step of the way,</i> but never get comfortable by keeping yourself constrained to the familiar. Make yourself uncomfortable by starting off slow or doing something terrifying.\n\n" +
      "Get out there and actually do it! Prepare to win scholarships and use that advantage wisely!\n\n",
  },
  challengesText: {
    timeMgmt:
      "Time management is becoming a skill that is getting increasingly harder to be good at. Our world is driven by information and temptation, all of which want to <b>seize</b> your attention and <b>hold it</b> for as long as possible. To put yourself ahead of the crowd, you need to be able to filter out distractions which sap your time and attention, without offering any real outcome.\n\n" +
      ...
      "The first principle takes a page out of Tim Ferriss’ book, <i>The 4-Hour Workweek</i>, and it has been a staple of my life for some time now.\n\n" +
      ...
      "It’s not about doing things well. It’s about doing the <i>right</i> things well. This extends to you too. For example, you could spend hours copying pristine and comprehensive notes from a math textbook, but without solving the problems yourself, you’ll have had no practice for when it counts. You’re great at taking notes, but the notes don’t get you where you want to be.\n\n" +
      "By cutting down on unimportant tasks, you can focus on what will advance you towards real results and your goals. This will save you lots of time from the work that doesn't drive you forwards.\n\n" +
      "<b>2. Maintain a determined ratio of productivity to enjoyment.</b>\n\n" +
      ...
      "Keep in mind that this is <b>not</b> a battle between good and evil, nor does it need to be a zero-sum game. Relaxation, entertainment and the like are equally as important as self investment, but they’re simply required in much smaller doses than you think. In addition, taking away from pure enjoyment <u>doesn’t mean reducing your overall enjoyment.</u> It means you should partake in fulfilling activities you enjoy which help to improve yourself instead of doing other enjoyable things like scrolling <i>mindlessly</i> on your phone (as I tend to catch myself doing).\n\n" +
    ...
    burnout:
      ...
      "<b>2.</b> <b>Over</b>-over-achieving or perfectionism; believing that you need to increase performance at all costs (even your health/well-being)\n\n" +
    ...
    impostor:
      ...
      "<b>But who said that was a bad thing?</b>\n\n" +
    ...
    dabbling:
      ...
      "It’s amazing to have a variety of interests, because you have the option to pursue as many as time allows! In this scenario, over your lifetime you might have the chance to be known as a <b>polymath</b> - someone with a wide range of varying knowledge. As a jack of all trades, you may have the ability to connect seemingly distant subjects to solve problems with solutions that are unobservable to a specialist.\n\n" +
      "One of the most prominent examples of polymathy is Aristotle. Among the greatest philosophers in recorded history, he drew from an expansive range of subject matter to create his works, including: <i>physics, biology, zoology, metaphysics, logic, ethics, aesthetics, poetry, theatre, music, rhetoric, psychology, linguistics, economics, politics, meteorology, and geology.</i> Say that five times fast!\n\n" +
    ...
    opportunities:
      "If you want to do more to invest in yourself but opportunities never seem to come your way, you’re <i>absolutely right</i>, they usually don’t! Similar to how your passions will never be handed to you, the worthwhile opportunities require some initiative to find.\n\n" +
      "The best ways to find the right investment activities for you are: <b>reaching out</b> to people you know, doing your own <b>research</b>, or <b>creating your own</b> opportunities!\n\n" +
  ...
  resourcesText: {
    searchEngines:
      "As you continue to build your potential and begin your last few years of highschool, you’ll likely want to get prepared to actually <b>win</b> some scholarships!\n\n" +
    ...
    books:
      ...
      "Of course these are just suggestions. If none pique your interest, go ahead and find what appeals to you! At this stage, just building the habit of reading relevant non-fiction content will undoubtedly provide benefits in more areas than you might think.\n\n" +
    ...
    amusingToDeath:
      "Written in 1985, the author Neil Postman demonstrates how our media of communication shape what and how information is circulated throughout society. In a pre-internet era, the book’s arguments revolve around television, though they extend and apply just as much (if not more) to today’s media landscape.\n\n" +
    ...
    range:
      "In today’s world we’re pushed more than ever to intensify our education into an ever narrowing field of specialization. <i>Range</i> explores many case studies of frequent failers who have traversed dozens of careers, only to become some of the highest performing, most well known individuals in their current roles.\n\n" +
      "Their success was fostered by a vast array of experiences that specialists would likely never have. So is it time to specialize, or generalize?\n\n",
    richDadPoorDad:
    ...
    barefootInvestor:
      "Scott Pape is an incredibly witty author. The only thing that outshine his coarse jokes and engaging storytelling is his rock-solid financial advice. From the moment you earn your first dollar to the day you retire, <i>The Barefoot Investor’s</i> teachings will be at your side to ensure you’ll never have a sleepless night due to your finances.\n\n" +
      "Since the book originates from Australia, you’ll be required to do a bit of cultural and procedural translation, but after that, your knowledge can be applied anywhere in the world.\n\n",
    bitcoinStandard:
    ...
    financialToolkit:
      ...
      "In conjunction with the books found elsewhere on the Resources page, you’ll be on your way to becoming a financial powerhouse. Keep on learning!\n\n",
    LinkedIn:
